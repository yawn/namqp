...
public final class ConnectionClose extends Connection {
    ...
    public ConnectionClose(ChannelBuffer channelBuffer) {
    ...
    public ConnectionClose(UnsignedShort replyCode, ShortString replyText, UnsignedShort classId, UnsignedShort methodId) {
